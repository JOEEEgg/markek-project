...
$(function(){
	...
	$("form").on("submit",function(event){
		...
		//	
			...
			event.preventDefault(); //43~56라인 주소가 안됨 
...
<p>*아이디</p>
<input type="text" name="userid" id="userid" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합"><br>
<span id="result"></span>

<p>*비밀번호</p><input type="text" name="passwd" id="passwd" placeholder="비밀번호를 입력해주세요"><br> 
<p>비빌번호확인</p><input type="text" name="passwd2" id="passwd2" placeholder="비밀번호를 한번 더 입력해주세요">
<span id="result2"></span>
<br> 
<p>이름</p><input type="text" name="username" placeholder="이름을 입력해주세요"><br> 
<p>주소</p><input type="text" name="post" id="sample4_postcode" placeholder="우편번호"><br>
